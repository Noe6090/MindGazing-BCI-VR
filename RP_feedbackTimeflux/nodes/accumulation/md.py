...
class AccumulationMDPred(AbstractAccumulation):
    ...
    def decision(self, timestamp):
        ...
        # Accumulate Momentum data for display and feedback?
        ...
        if (
           ...
           and
            self._consec[target] > self._min_frames_pred
        ):
            ...
            if self._frames > self._max_frames_pred:
    ...
    def reset(self):
        ...
        self._target_acc = 0
        self._momentum = self._momentum_floor*np.ones(len(self.codes))/2
